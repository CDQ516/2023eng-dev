...
(cl:defmethod cl:initialize-instance :after ((m <joint_angle_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joint_angle_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maggie_board_comm-msg:<joint_angle_cmd> is deprecated: use maggie_board_comm-msg:joint_angle_cmd instead.")))

(cl:ensure-generic-function 'joint1-val :lambda-list '(m))
(cl:defmethod joint1-val ((m <joint_angle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maggie_board_comm-msg:joint1-val is deprecated.  Use maggie_board_comm-msg:joint1 instead.")
  (joint1 m))

(cl:ensure-generic-function 'joint2-val :lambda-list '(m))
(cl:defmethod joint2-val ((m <joint_angle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maggie_board_comm-msg:joint2-val is deprecated.  Use maggie_board_comm-msg:joint2 instead.")
  (joint2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<joint_angle_cmd>)))
  ...
  "maggie_board_comm/joint_angle_cmd")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'joint_angle_cmd)))
  "Returns string type for a message object of type 'joint_angle_cmd"
  "maggie_board_comm/joint_angle_cmd")
